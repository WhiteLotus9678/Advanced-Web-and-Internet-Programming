...
var _GameGrid = __webpack_require__(/*! ./GameGrid.jsx */ "./client/GameGrid.jsx");

var _GameGrid2 = _interopRequireDefault(_GameGrid);

var _GameDetailsModal = __webpack_require__(/*! ./GameDetailsModal.jsx */ "./client/GameDetailsModal.jsx");

var _GameDetailsModal2 = _interopRequireDefault(_GameDetailsModal);
...
var GameBrowser = function (_React$Component) {
  _inherits(GameBrowser, _React$Component);
  ...
  _createClass(GameBrowser, [{
    ...
    value: function render() {
      if (this.state.gameID) {
        ...
        return _react2.default.createElement(
          'div',
          null,
          _react2.default.createElement(_GameGrid2.default, { triggerDetails: this.triggerDetailsUpdate }),
          _react2.default.createElement(_GameDetailsModal2.default, { id: this.state.gameID })
        );
      } else {
    ...
    value: function triggerDetailsUpdate(gameID) {
...
var GameDetailsModal = function (_React$Component) {
  _inherits(GameDetailsModal, _React$Component);

  function GameDetailsModal(props) {
    _classCallCheck(this, GameDetailsModal);

    // Initialize component state to empty
    var _this = _possibleConstructorReturn(this, (GameDetailsModal.__proto__ || Object.getPrototypeOf(GameDetailsModal)).call(this, props));
  ...
  _createClass(GameDetailsModal, [{
    ...
    key: 'fetchGameDetails',
    value: function fetchGameDetails(id) {
      var _this2 = this;

      // Query the all-games API
      fetch('/api/game/' + id).then(function (res) {
...
GameDetailsModal.propTypes = {
  ...
  // Expose this component for import in other files
};exports.default = GameDetailsModal;
...
var _GameSummary = __webpack_require__(/*! ./GameSummary.jsx */ "./client/GameSummary.jsx");
...
var GameGrid = function (_React$Component) {
  ...
  function GameGrid(props) {
    ...
    var _this = _possibleConstructorReturn(this, (GameGrid.__proto__ || Object.getPrototypeOf(GameGrid)).call(this, props));
  ...
  _createClass(GameGrid, [{
    ...
    value: function componentDidMount() {
      ...
      fetch('/api/allGames').then(function (res) {
        if (res.status !== 200) {
    ...
    value: function render() {
      ...
      if (this.state.ready) {
        ...
        this.state.games.forEach(function (game) {
          summaries.push(_react2.default.createElement(_GameSummary2.default, _extends({}, game, {
            key: game.id,
...
var GameSummary = function (_React$Component) {
  ...
  function GameSummary() {
    ...
    return _possibleConstructorReturn(this, (GameSummary.__proto__ || Object.getPrototypeOf(GameSummary)).apply(this, arguments));
  }
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            'a',
            { className: 'gameButton', onClick: function onClick(event) {
...
GameSummary.propTypes = {
  ...
  minPlayers: _propTypes2.default.number,
  maxPlayers: _propTypes2.default.number
...
var _GameBrowser = __webpack_require__(/*! ./GameBrowser.jsx */ "./client/GameBrowser.jsx");
...
_reactDom2.default.render(_react2.default.createElement(
  'div',
  { className: 'container' },
  _react2.default.createElement(_PageTitle2.default, { title: 'Game Browser', subtitle: 'Browse through 100 board games from www.boardgamegeek.com!' }),
  _react2.default.createElement(_GameBrowser2.default, null)
),
