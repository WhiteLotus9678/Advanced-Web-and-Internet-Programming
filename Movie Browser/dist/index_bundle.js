...
var _MovieGrid = __webpack_require__(/*! ./MovieGrid.jsx */ "./client/MovieGrid.jsx");

var _MovieGrid2 = _interopRequireDefault(_MovieGrid);

var _MovieDetailsModal = __webpack_require__(/*! ./MovieDetailsModal.jsx */ "./client/MovieDetailsModal.jsx");

var _MovieDetailsModal2 = _interopRequireDefault(_MovieDetailsModal);
...
function _inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function, not " + typeof superClass); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; } // Bring in the react library


// The larger movie browser that contains both a grid and the modal details
var MovieBrowser = function (_React$Component) {
  _inherits(MovieBrowser, _React$Component);

  function MovieBrowser(props) {
    _classCallCheck(this, MovieBrowser);

    // Bind the triggerDetailsUpdate funciton to always
    // have the current object as its 'this' param
    var _this = _possibleConstructorReturn(this, (MovieBrowser.__proto__ || Object.getPrototypeOf(MovieBrowser)).call(this, props));

    _this.triggerDetailsUpdate = _this.triggerDetailsUpdate.bind(_this);
  ...
  _createClass(MovieBrowser, [{
    ...
    value: function render() {
      if (this.state.movieID) {
        ...
        return _react2.default.createElement(
          'div',
          null,
          _react2.default.createElement(_MovieGrid2.default, { triggerDetails: this.triggerDetailsUpdate }),
          _react2.default.createElement(_MovieDetailsModal2.default, { id: this.state.movieID })
        );
      } else {
    ...
    key: 'triggerDetailsUpdate',
    value: function triggerDetailsUpdate(movieID) {
...
exports.default = MovieBrowser;

/***/ }),

/***/ "./client/MovieDetailsModal.jsx":
/*!**************************************!*\
  !*** ./client/MovieDetailsModal.jsx ***!
  \**************************************/
/*! no static exports found */
...
function _inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function, not " + typeof superClass); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; } // jQuery is defined but eslint doesn't know about it
...
var MovieDetailsModal = function (_React$Component) {
  _inherits(MovieDetailsModal, _React$Component);

  function MovieDetailsModal(props) {
    _classCallCheck(this, MovieDetailsModal);

    // Initialize component state to empty
    var _this = _possibleConstructorReturn(this, (MovieDetailsModal.__proto__ || Object.getPrototypeOf(MovieDetailsModal)).call(this, props));

    _this.state = {};
    _this.modalID = 'detailsModal-' + _this.props.id;
    return _this;
  }
  ...
  _createClass(MovieDetailsModal, [{
    ...
    value: function fetchMovieDetails(id) {
      var _this2 = this;

      // Query the all-movies API
      fetch('/api/movie/' + id).then(function (res) {
    ...
    value: function render() {
      ...
      if (this.state.movie) {
        ...
        return _react2.default.createElement(
          'div',
          { className: 'modal fade', id: this.modalID },
...
MovieDetailsModal.propTypes = {
  ...
  // Expose this component for import in other files
};exports.default = MovieDetailsModal;

/***/ }),

/***/ "./client/MovieGrid.jsx":
/*!******************************!*\
  !*** ./client/MovieGrid.jsx ***!
  \******************************/
/*! no static exports found */
...
var _MovieSummary = __webpack_require__(/*! ./MovieSummary.jsx */ "./client/MovieSummary.jsx");

var _MovieSummary2 = _interopRequireDefault(_MovieSummary);
...
var MovieGrid = function (_React$Component) {
  ...
  function MovieGrid(props) {
    ...
    var _this = _possibleConstructorReturn(this, (MovieGrid.__proto__ || Object.getPrototypeOf(MovieGrid)).call(this, props));
  ...
  _createClass(MovieGrid, [{
    ...
    value: function componentDidMount() {
      ...
      // Query the all-movies API
      fetch('/api/allMovies').then(function (res) {
        // Examine response status
        if (res.status !== 200) {
    ...
    value: function render() {
      ...
      if (this.state.ready) {
        ...
        this.state.movies.forEach(function (movie) {
          summaries.push(_react2.default.createElement(_MovieSummary2.default, _extends({}, movie, { key: movie.id,
            triggerDetails: _this3.props.triggerDetails })));
        });
...
MovieGrid.propTypes = {
  triggerDetails: _propTypes2.default.func.isRequired
...
var MovieSummary = function (_React$Component) {
  _inherits(MovieSummary, _React$Component);

  function MovieSummary() {
    _classCallCheck(this, MovieSummary);

    return _possibleConstructorReturn(this, (MovieSummary.__proto__ || Object.getPrototypeOf(MovieSummary)).apply(this, arguments));
  }

  _createClass(MovieSummary, [{
    key: 'render',
    value: function render() {
      var _this2 = this;
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            'a',
            { className: 'movieButton', href: '#', onClick: function onClick(event) {
                event.preventDefault();
                _this2.props.triggerDetails(_this2.props.id);
              } },
            _react2.default.createElement(
              'span',
            ...
            _react2.default.createElement('img', { alt: this.props.name, src: 'images/thumbs/' + this.props.image })
          ),
...
MovieSummary.propTypes = {
  ...
  genres: _propTypes2.default.string,
  year: _propTypes2.default.number,
  rated: _propTypes2.default.string

  // Expose this component for import in other files
};exports.default = MovieSummary;

/***/ }),

/***/ "./client/PageTitle.jsx":
/*!******************************!*\
  !*** ./client/PageTitle.jsx ***!
  \******************************/
/*! no static exports found */
...
var _PageTitle = __webpack_require__(/*! ./PageTitle.jsx */ "./client/PageTitle.jsx");

var _PageTitle2 = _interopRequireDefault(_PageTitle);

var _MovieBrowser = __webpack_require__(/*! ./MovieBrowser.jsx */ "./client/MovieBrowser.jsx");

var _MovieBrowser2 = _interopRequireDefault(_MovieBrowser);
...
_reactDom2.default.render(_react2.default.createElement(
  'div',
  { className: 'container' },
  _react2.default.createElement(_PageTitle2.default, { title: 'Movie Browser', subtitle: 'Click on a movie to view its details' }),
  _react2.default.createElement(_MovieBrowser2.default, null)
),
